...
set_config_value "$OSE_CONF/$OSE_CONF_FILE" MAILBOX_EXPORT_RETRY_COUNT "$MAILBOX_EXPORT_RETRY_COUNT"
set_config_value "$OSE_CONF/$OSE_CONF_FILE" MAILBOX_EXPORT_RETRY_WAIT_SECONDS "$MAILBOX_EXPORT_RETRY_WAIT_SECONDS"
